...
* 逐个执行 5 本任务式 notebook (generator/astra/postpro/lineplot/fieldplot):
...
* examples/ 下 8 本单算例示例 notebook (如 Manual_Example.ipynb)
  各自只跑一个算例并展示其代表性图, 另有 6 本功能演示 demo
  (generator 参数化 / BFF 对照 / 统计量交叉验证 / lineplot 专题 /
  fieldplot 场图专题 / postpro 全菜单 + 步进演示)
  (共 5+14 本, 约 5-6 分钟)。
...
* test_plot_audit.py — 全部绘图函数渲染审计 (70 图, 含标签/有限性/字体熔断)
